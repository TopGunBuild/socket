...
const binaryToBase64Replacer = function (key: string, value: any): {base64: boolean, data: string}
{
...
export function decode(encodedMessage: string): string
{
...
export function encode(rawData: any): string
{
    // Leave ping or pong message as is
